...
const Book3 = () => {
  ...
  const [backgroundImage, setBackgroundImage] = useState(
    "https://i.pinimg.com/474x/de/e0/e6/dee0e680d36bfa93c6226a024ceb5616.jpg"
  );
    ...
    <div className="w-full">
      ...
      >
        <select onChange={handleSelectChange}>
          <option value="https://i.pinimg.com/474x/de/e0/e6/dee0e680d36bfa93c6226a024ceb5616.jpg">
            Initial Background
          </option>
