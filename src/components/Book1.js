  ...
  return (
    <div className="w-full">
      <div
        style={{
          backgroundImage:
            'url("https://png.pngtree.com/png-clipart/20211017/original/pngtree-simple-and-elegant-cover-design-perfect-for-book-covers-portfolios-png-image_6857715.png")',
